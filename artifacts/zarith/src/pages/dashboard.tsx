                ...
                {[40, 70, 45, 90, 65, 80, 50].map((h, i) => (
                  <div key={i} className="flex-1 flex flex-col items-center gap-2 group">
                    <motion.div
                      initial={{ height: 0 }}
                      animate={{ height: `${h}%` }}
                      className="w-full bg-gradient-to-t from-[var(--accent-purple)] to-[var(--accent-cyan)] rounded-t-lg transition-all"
                    />
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4">
                    <div className={`w-2 h-2 rounded-full bg-[var(--accent-${item.color})]`} />
